...
This project simulates a four-way stop-sign intersection using POSIX threads in C. Each car is represented by a thread that arrives, waits, crosses the intersection, and exits according to realistic traffic rules.
